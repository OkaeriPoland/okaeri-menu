...
/**
 * Holds menu configuration data for the legacy 1.x API.
 * <p>
 * This class is part of the compatibility layer and will be removed in a future version.
 * For new code, use the 2.0 API with {@link eu.okaeri.menu.bukkit.Menu} and builder pattern instead.
 *
 * @deprecated Use {@link eu.okaeri.menu.bukkit.Menu} with builder pattern in the 2.0 API
 * @see eu.okaeri.menu.bukkit.Menu
 */
